...
@section('content')
    <div class="container">
        <div class="row">
            @if(request()->route() =="questions.create")
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="{{route('questions.store')}}" method="post" role="form">
                                ...
                                <div class="form-group">
                                    <label for="title">Title</label>
                                    <input type="text" class="form-control" name="title" id="title" placeholder="Questions Title" value="{{$question->title}}">
                                </div>
                                <div class="form-group">
                                    <label for="body">Body</label>
                                    <textarea name="body" id="body" cols="30" rows="10" placeholder="Explain your question" class="form-control">{{$question->body}}</textarea>
                                </div>
